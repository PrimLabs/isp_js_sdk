...
export type BurnResult = { 'Ok': TransactionId } |
  { 'Err': BurnError };
export type CreateResult = { 'Ok': { 'canister_id': Principal } } |
  { 'Err': string };
...
export type MintResult = { 'Ok': TransactionId } |
  { 'Err': MintError };
...
export type TransactionStatus = { 'FAILED': null } |
  { 'SUCCEEDED': null };
export type TxError = { 'NotifyDfxFailed': null } |
...
export type TxReceipt = { 'Ok': bigint } |
  { 'Err': TxError };
export type TxReceiptLegacy = { 'Ok': bigint } |
  {
...
export interface _SERVICE {
  ...
  'burn': ActorMethod<[{ 'canister_id': Principal, 'amount': bigint }],
    BurnResult>,
  'decimals': ActorMethod<[], number>,
  'events': ActorMethod<[{ 'offset': [] | [bigint], 'limit': number }],
    EventsConnection>,
  ...
  'mint_by_icp': ActorMethod<[[] | [Array<number>], bigint], TxReceipt>,
  ...
  'wallet_call': ActorMethod<[
    ...
    ResultCall>,
  'wallet_create_canister': ActorMethod<[{ 'controller': [] | [Principal], 'cycles': bigint }],
    CreateResult>,
  'wallet_create_wallet': ActorMethod<[{ 'controller': [] | [Principal], 'cycles': bigint }],
    CreateResult>,
  'wallet_send': ActorMethod<[{ 'canister': Principal, 'amount': bigint }],
    ResultSend>,
}
